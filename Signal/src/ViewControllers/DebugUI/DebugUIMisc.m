...
- (nullable OWSTableSection *)sectionForThread:(nullable TSThread *)thread
{
    ...
    [items addObject:[OWSTableItem itemWithTitle:@"Re-register"
                                     actionBlock:^{
                                         
                                         [OWSAlerts showConfirmationAlertWithTitle:@"Re-register?"
                                                                           message:@"If you proceed, you will not lose any of your current messages, but your account will be deactivated until you complete re-registration."
                                                                     ...
                                                                     proceedAction:^(UIAlertAction * _Nonnull action) {
                                                                         ...
                                                                         OWSSyncPushTokensJob *syncPushTokensJob = [[OWSSyncPushTokensJob alloc] initWithPushManager:[PushManager sharedManager]
